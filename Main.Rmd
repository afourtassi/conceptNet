...
assoc_graph <- graph_from_data_frame(assoc_links, directed=FALSE, vertices=lemma_list) %>%
  simplify()

feature_graph <- graph_from_data_frame(feature_links, directed=FALSE, vertices=lemma_list) %>%
  simplify()

print(assoc_graph, e=TRUE, v=TRUE)
print(feature_graph, e=TRUE, v=TRUE)
```
