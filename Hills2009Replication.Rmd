...
Hills selected nouns from the Todler version of the MacArthur-Bates Communicative Developmental Inventory. This includes nouns which were aquired by 50% of children by 30 months.

*This needs to be fixed to match Hills exactly*.
```{r warning=FALSE}
